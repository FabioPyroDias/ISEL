...
public class GUI extends JFrame {
	...
	public GUI(minhasVariaveis mv) 
	{
		...
		distanciaTextField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				try
				{
					...
					myPrint("Distância: " + mv.getDistancia());
				}
				catch(NumberFormatException e)
				{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				if(powerRadioButton.isSelected())
				{
					if(mv.getRobot().OpenEV3(mv.getNomeRobot()))
					{
						...
						myPrint("O canal de comunicação está aberto com sucesso");
						mv.setPower(powerRadioButton.isSelected());
					}
					else
					{
						powerRadioButton.setSelected(false);
						myPrint("O canal de comunicação falhou");
						mv.setPower(powerRadioButton.isSelected());
					}
				}
				else
				{
					...
					myPrint("O canal de comunicação está fechado");
					mv.setPower(powerRadioButton.isSelected());
				}
		...
		JCheckBox vaguearCheckBox = new JCheckBox("Vaguear");
		...
		vaguearCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				myPrint("Vaguear: " + (mv.isVaguear()? "Sim" : "Não"));
			}
		});
		...
		JCheckBox evitarCheckBox = new JCheckBox("Evitar");
		...
		evitarCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				myPrint("Evitar: " + (mv.isEvitar()? "Sim" : "Não"));
			}
		});
