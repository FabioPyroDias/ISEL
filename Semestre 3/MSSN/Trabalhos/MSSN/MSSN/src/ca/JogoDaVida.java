...
public class JogoDaVida implements IProcessingApp{
	...
	public void setup(PApplet parent) {
		...
		System.out.println("Activar e Desactivar as células é efectuado com o lado esquerdo do rato");
		System.out.println("Existem alguns padrões pré-definidos que pode aceder com os números de 1 a 4");
		System.out.println("1 - Blinker | 2 - Major Blinker");
		System.out.println("3 - Heart   | 4 - Flower");
		System.out.println("Para começar as iterações, pressionar barra de espaços");
		System.out.println("Se quiser parar ou resumir as iterações, pressionar barra de espaços novamente");	
	}
