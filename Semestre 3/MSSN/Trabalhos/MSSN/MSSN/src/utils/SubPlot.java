...
public class SubPlot {
	...
	// Converte a posição de um ponto no mundo em pixéis (coordenada)
	...
	// Converte a posição de um ponto em pixéis para coordenadas no mundo
	...
	// Converte as cordenadas de um vetor no mundo para pixéis
	public float[] getDimInPixel(double dx, double dy) {
		float[] v = new float[2];
		v[0] = (float) (dx*mx);
		v[1] = (float) (dy*my); // coordenadas no eixo do y estão invertidas
		return v;
	}
