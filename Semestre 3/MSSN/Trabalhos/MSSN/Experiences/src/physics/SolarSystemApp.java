...
public class SolarSystemApp implements IProcessingApp{
	...
	private float speedUp = 60 * 60 * 3; //Erro
	
	@Override
	public void setup(PApplet parent) {
		plt = new SubPlot(window, viewport, parent.width, parent.height);
		sun = new CelestialBody(new PVector(), new PVector(), sunMass, distEarthSun/10, parent.color(255, 128, 0));
		earth = new CelestialBody(new PVector(0, distEarthSun), new PVector(earthSpeed, 0), earthMass, distEarthSun/20, parent.color(0, 180, 120));	
	}
