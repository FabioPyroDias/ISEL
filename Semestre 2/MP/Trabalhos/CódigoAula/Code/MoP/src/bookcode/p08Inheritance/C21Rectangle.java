...
/**
 * A class that extends from other class and implements an interface.
 * 
 ...
 * class ShapeBasics.
 */
public class C21Rectangle extends C20ShapeBase implements
		C10IRectangleInterface {
	private int height;
	private int width;
	...
	public C21Rectangle(int theOffset, int theHeight, int theWidth) {
		super(theOffset);
		height = theHeight;
		width = theWidth;
	}
