 ...
 */
public class C09StringLinkedListWithIterator {
	private ListNode head;
	private ListNode current;
	private ListNode previous;

	public C09StringLinkedListWithIterator() {
		head = null;
		current = null;
		previous = null;
	}
	...
	/**
	 * Inner class that supports the list node
	 */
	...
	public static void main(String[] args) {
		C09StringLinkedListWithIterator list = new C09StringLinkedListWithIterator();
